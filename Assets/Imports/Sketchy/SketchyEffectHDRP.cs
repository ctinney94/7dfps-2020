...
[Serializable, VolumeComponentMenu("Post-processing/Custom/Flockaroo/Sketchy")]
public sealed class SketchyEffectHDRP : CustomPostProcessVolumeComponent, IPostProcessComponent {
    ...
    public ClampedFloatParameter Colors = new ClampedFloatParameter(0.600000f, 0.0f, 1.0f);
    public ClampedFloatParameter ColorsBlur = new ClampedFloatParameter(0.400000f, 0.0f, 1.0f);
    public ClampedFloatParameter MasterFade = new ClampedFloatParameter(1.000000f, 0.0f, 1.0f);
    public ClampedFloatParameter Noise = new ClampedFloatParameter(0.200000f, 0.0f, 1.0f);
    public ClampedFloatParameter Outlines = new ClampedFloatParameter(0.400000f, 0.0f, 1.0f);
    public ClampedFloatParameter OutlinesBlur = new ClampedFloatParameter(0.100000f, 0.0f, 1.0f);
    public ClampedFloatParameter StrokeSpread = new ClampedFloatParameter(0.100000f, 0.0f, 1.0f);
    public ClampedFloatParameter StrokeThresh = new ClampedFloatParameter(0.250000f, 0.0f, 1.0f);
    public ClampedFloatParameter VignWidth = new ClampedFloatParameter(0.040000f, 0.0f, 1.0f);
    public ClampedFloatParameter Vignetting = new ClampedFloatParameter(0.500000f, 0.0f, 1.0f);
    public ClampedFloatParameter NumTriangles = new ClampedFloatParameter(131072.000000f, 0.0f, 1000000.0f);
    //###PublicVars
    [Header("Other")]
    ...
    void initAll(int width, int height)
    {
        ...
        shaders["Image"] = createShader("flockaroo_Sketchy/ImageHDRP");
        ...
        shaders["Geom_A"] = createShader("flockaroo_Sketchy/Geom_AHDRP");
    ...
    public override void Render(CommandBuffer cmd, HDCamera camera, RTHandle src_h, RTHandle dest_h) {
        ...
        if(gammaShader==null) gammaShader = createShader("flockaroo_Sketchy/GammaCorrectShader");
        ...
        foreach( string buffName in bufferOrder )
        {
            ...
            mat.SetFloat("Colors",Colors.value);
            mat.SetFloat("ColorsBlur",ColorsBlur.value);
            mat.SetFloat("MasterFade",MasterFade.value);
            mat.SetFloat("Noise",Noise.value);
            mat.SetFloat("Outlines",Outlines.value);
            mat.SetFloat("OutlinesBlur",OutlinesBlur.value);
            mat.SetFloat("StrokeSpread",StrokeSpread.value);
            mat.SetFloat("StrokeThresh",StrokeThresh.value);
            mat.SetFloat("VignWidth",VignWidth.value);
            mat.SetFloat("Vignetting",Vignetting.value);
            mat.SetFloat("Geom_A_NumTriangles",NumTriangles.value);
            meshNumTri["Geom_A"]=(int)NumTriangles.value;
            //###MatParams
