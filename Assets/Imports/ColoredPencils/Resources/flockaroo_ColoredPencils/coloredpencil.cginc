...
{
    return texture(_GradTex, pos/iResolution.xy);
}
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    fragColor.xyz=paperCol-contour*(1.-outlineColor);
    ...
    fragColor.xyz=hatch*(1.-1.5*contour*(1.0-outlineColor));
    ...
    if(effectMaskFade!=0.)
    {
        ...
        fragColor.xyz=mix(fragColor.xyz,getCol2(fragCoord).xyz,effectMaskFade*effectMask);
    }
...
#define PANFADE_W 0.025
    ...
    if(true)
    {
        ...
        fragColor.xyz *= mix(vign,1.,effectFade);
    }
